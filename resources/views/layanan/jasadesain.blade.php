    ...
    <section class="bg-gray-50 px-4 pt-10 pb-6">
        <section class="bg-gray-50 px-4 pt-[80px] pb-6"> <!-- padding top agar tidak ketutup -->
            ...
            <h1 class="text-3xl sm:text-4xl font-extrabold mb-6 text-center">
                ...
                <span class="text-[#0D7AC6]">Desain</span>
            ...
            <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4 pt-8 md:pt-12">
                ...
                <div class="max-w-5xl w-full rounded-xl border border-gray-300 bg-white p-6 md:p-10 font-sans text-black">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 md:gap-10">
                        ...
                        <div class="md:basis-2/3 bg-white rounded-lg p-2 flex gap-4 overflow-x-auto md:overflow-visible">
                        ...
                        <div>
                            ...
                            <ul class="space-y-1">
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>
                                    1 Desain Logo Utama dengan 5 Revisi
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Format File: PNG, JPG, dan Vector (AI, EPS, SVG)
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Resolusi Tinggi untuk Cetak dan Digital
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Warna Logo Sesuai Permintaan dan Branding Anda
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    File Logo Siap Pakai untuk Website dan Media Sosial
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>
                                    Pengerjaan 5 Hari Kerja Setelah Brief Diterima
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Hak Cipta Logo Sepenuhnya Milik Anda
                                    </span>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="space-y-1">
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>
                                    Konsultasi Desain dengan Tim Profesional
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>
                                        Gratis SSL untuk keamanan website
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Revisi Sesuai Feedback Hingga Maksimal 3 Kali
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    File Logo Dalam Berbagai Format untuk Kebutuhan Berbeda
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                        ...
                        <div>
                            ...
                            <ul class="space-y-1">
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>
                                    Desain responsif untuk semua perangkat (desktop, tablet, mobile)
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Maksimal 5 halaman website (Beranda, Tentang, Layanan, Galeri, Kontak)
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Integrasi CMS sederhana untuk update konten mudah
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Garansi revisi desain sampai 3 kali
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Waktu pengerjaan 7-10 hari kerja setelah briefing lengkap
                                    </span>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="space-y-1">
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>
                                    Konsultasi Desain dengan Tim Profesionalntegrasi media sosial (Facebook, Instagram, LinkedIn)
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Form kontak dan peta lokasi interaktif
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                    ...
                                    <span>
                                    Galeri foto produk atau portfolio
                                    </span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <i class="fas fa-check-circle text-green-500 mt-[3px]">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>
                                    Mobile friendly dan user-friendly interface
                                    </span>
                                </li>
                            </ul>
                        </div>
